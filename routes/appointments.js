const { getAvailabilityForDate, createAppointment, getAppointmentsByPatientId } = require("../services/firebaseService"); 
...
exports.postAppointment = async (req, res) => { 
    try {
        ...
        const newAppointment = await createAppointment(clinicId, date, timeSlot, patientId);
